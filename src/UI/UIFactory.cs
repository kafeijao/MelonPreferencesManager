...
namespace MelonPrefManager.UI
{
    public static class UIFactory
    {
        ...
        public static GameObject CreateUIObject(string name, GameObject parent = null, Vector2 size = default)
        {
            if (!parent)
            {
                PrefManagerMod.LogWarning("Cannot create UI object as the parent is null or destroyed! (" + name + ")");
                return null;
            }
        ...
        /// </summary>
        public static GameObject CreatePanel(string name, out GameObject contentHolder)
        {
            ...
            SetLayoutGroup<VerticalLayoutGroup>(contentHolder, false, true, true, true, 3, 3, 3, 3, 3);
        ...
        public static GameObject CreateInputField(GameObject parent, string name, string placeHolderText, int fontSize = 14, int alignment = 3, int wrap = 0)
        {
            ...
            mainImage.color = new Color(0.05f, 0.05f, 0.05f);
            ...
            Color? color = default)
        {
            ...
            mainObj.AddComponent<Image>().color = color ?? new Color(0.12f, 0.12f, 0.12f);
